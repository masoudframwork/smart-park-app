...
class NafathOtpScreen extends StatelessWidget {
            ...
            child: Column(
                ...
                children: [
                  ...
                  AppText(
                    ...
                    appTextTheme: AppTextTheme.titleMSTextStyle()
                  ...
                  AppText(
                    text: 'سيتم التحديث خلال 00:23 ثانية',
                    ...
                    onPressed: () {
                      showDialog(
                          ...
                          builder: (_) => AppResultDialog(
                                ...
                                buttonText: 'استمرار',
                                onButtonPressed: () {
                                  NavigationService.push('/bankCardDataPage',
                                      context: context);
                                },
